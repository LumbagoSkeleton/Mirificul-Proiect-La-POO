...
namespace Proiect_Poo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            tren1.addVagons(new List<int>() { 60, 40, 30 }, new List<int>() { 1, 2, 3 }, new List<int>() { 2, 2, 2 }, new List<int>() { 6, 4, 3 }, new List<int>() { 10, 10, 10 });
            ...
            while (true) // meniu consola pentru debugging
            {
                Console.WriteLine("  | MENIU DEBUGGING | \n" +
                                  ...
                                  "5) Rezervare pe un loc dorit ( o persoana sau mai multe ) ( work in progress )");
                ...
                switch (menuValue)
                {
                    ...
                    case 5:
                        ...
                        if (opt1 == 0)
                        {
                            ...
                            {
                                var Calator_nou = new Calator(nume, prenume, varsta, clasa, DateTime.Now);
                                ListaRute.RezervareRutaCalator(st1, st2, Calator_nou,numarVagon,numarLoc);
                            }
                            else
                            {
                                Console.WriteLine("Reintroduceti optiunea 1 pt. a reintroduce statiile corect. O statie invalida sau amandoua!");
